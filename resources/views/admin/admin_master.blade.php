...
<head>
    ...
    <title>DnvMaster - Admin panel</title>
    ...
    <link href="{{ asset('backend/assets/img/favicon.png') }}" rel="stylesheet icon" />
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-header">
                                    ...
                                    <div class="d-inline-block">
                                        {{ Auth::user()->name }} <small class="pt-1">dnvmaster50@gmail.com</small>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <a href="email-inbox.html">
                                        <i class="mdi mdi-email"></i> Сообщения
                                    </a>
                                </li>
                                <li>
